...
<div class="wrapper-md">
            ...
            <tr>
              ...
              <td>
                <?= Html::a('<button class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Profile"><i class="icon-user"></i></button>', null,
                      [
                        'data-toggle' => 'modal',
                        'data-target' => '#profile-speaker',
                        'value' => $row["id"],
                        'onClick' => '
                          $value = $(this).attr("value");
                          $.post("index.php?r=site/profile&id='.'"+$value,function(data){
                            $("#profile-speaker .modal-content").html(data)
                          })
                        '
                      ]); 
                ?>
                ...
                ?>   
                <a href="#" data-toggle="modal" data-target="#delete-speaker" value=""><button class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Delete"><i class="icon-trash"></i></button></a> 
              </td>
            </tr>
          <?php
            $no++;
  ...
  <!-- Modal Profile Pegawai -->
      <div class="modal fade" id="profile-speaker" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <!-- Modal Reset Password Speaker -->
      <div class="modal fade" id="edit-speaker" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          </div>
